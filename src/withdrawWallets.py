...
def loadWallets():
    try:
        with open("withdrawWallets.json", "r") as final:
            return json.load(final)
    except FileNotFoundError:
        print("File withdrawWallets.json not found.")
        return []
    except:
        print("Errors with withdrawWallets.json file.")
        return []
...
async def saveWalletsDB():
    with open("withdrawWallets.json", "w") as final:
